...
func pose_bone(bone: UltraleapBone, bone_id: int, is_right: bool, is_thumb: bool = false) -> void:
	...
	var temp = parent_transform.affine_inverse()
	# set pose
...
func _process(_delta):
	...
	if frame != null and frame.is_right_hand_visible:
		...
		# fingers
		pose_bone(frame.right_hand.thumb.proximal, 37, true)
		#pose_bone(frame.right_hand.thumb.intermediate, 38, true, true)
		#pose_bone(frame.right_hand.thumb.distal, 39, true, true)
		
		pose_bone(frame.right_hand.index.metacarpal, 41, true)
		pose_bone(frame.right_hand.index.proximal, 42, true)
		pose_bone(frame.right_hand.index.intermediate, 43, true)
		pose_bone(frame.right_hand.index.distal, 44, true)
		
		pose_bone(frame.right_hand.middle.metacarpal, 45, true)
		pose_bone(frame.right_hand.middle.proximal, 46, true)
		pose_bone(frame.right_hand.middle.intermediate, 47, true)
		pose_bone(frame.right_hand.middle.distal, 48, true)
		
		pose_bone(frame.right_hand.ring.metacarpal, 49, true)
		pose_bone(frame.right_hand.ring.proximal, 50, true)
		pose_bone(frame.right_hand.ring.intermediate, 51, true)
		pose_bone(frame.right_hand.ring.distal, 52, true)
		
		pose_bone(frame.right_hand.pinky.metacarpal, 53, true)
		pose_bone(frame.right_hand.pinky.proximal, 54, true)
		pose_bone(frame.right_hand.pinky.intermediate, 55, true)
		pose_bone(frame.right_hand.pinky.distal, 56, true)
	...
	if frame != null and frame.is_left_hand_visible:
		...
		#fingers
		pose_bone(frame.left_hand.thumb.proximal, 13, false)
		#pose_bone(frame.left_hand.thumb.intermediate, 14, false, true)
		#pose_bone(frame.left_hand.thumb.distal, 15, false, true)
		
		pose_bone(frame.left_hand.index.metacarpal, 17, false)
		pose_bone(frame.left_hand.index.proximal, 18, false)
		pose_bone(frame.left_hand.index.intermediate, 19, false)
		pose_bone(frame.left_hand.index.distal, 20, false)
		
		pose_bone(frame.left_hand.middle.metacarpal, 21, false)
		pose_bone(frame.left_hand.middle.proximal, 22, false)
		pose_bone(frame.left_hand.middle.intermediate, 23, false)
		pose_bone(frame.left_hand.middle.distal, 24, false)
		
		pose_bone(frame.left_hand.ring.metacarpal, 25, false)
		pose_bone(frame.left_hand.ring.proximal, 26, false)
		pose_bone(frame.left_hand.ring.intermediate, 27, false)
		pose_bone(frame.left_hand.ring.distal, 28, false)
		
		pose_bone(frame.left_hand.pinky.metacarpal, 29, false)
		pose_bone(frame.left_hand.pinky.proximal, 30, false)
		pose_bone(frame.left_hand.pinky.intermediate, 31, false)
		pose_bone(frame.left_hand.pinky.distal, 32, false)
